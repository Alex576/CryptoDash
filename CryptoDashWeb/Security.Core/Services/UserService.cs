...
namespace Security.Core.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<bool> Validate(string userName, string password)
        {
            ...
            var user = await m_Context.Users.FirstAsync(u => u.Email == userName && u.Password.Equals(passwordHash));
            return user != null;
        }
        ...
        public async Task<User?> GetUser(string userName, string password)
        {
            ...
            var user = await m_Context.Users.FirstOrDefaultAsync(u => u.Email == userName && u.Password.Equals(passwordHash));
            return user;
        }
        ...
        /// <param name="password">Normal string, hash calculating will be done in this method</param>
        /// <returns></returns>
        public async Task<UserModel> AddUser(UserModel user, string password)
        {
            ...
            m_Context.Users.Add(userEntity);
